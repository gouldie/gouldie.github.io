...
attempting to render a list without providing a key to each list item.
...
diffing algorithm</a>&nbsp;, it cannot efficiently determine when a list order changes, or when
