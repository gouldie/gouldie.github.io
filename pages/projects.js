...
const projects = [
  ...
  },
  {
    ...
    tech: ['React', 'Next.js'],
    url: 'https://collector-three.vercel.app'
  },
  { name: 'empty-1', empty: true },
  { name: 'empty-2', empty: true }
]
    ...
    <Layout>
      ...
      <div className='flex justify-center flex-wrap'>
        {projects.map(project =>
          project.empty ? (
            <div key={project.name} className='max-w-xs m-5 w-full' />
          ) : (
            <div
              key={project.name}
            ...
            >
              ...
              <div className='p-5 flex flex-col justify-between items-start grow'>
                ...
                <a
                  ...
                  target='_blank'
                  className='unstyled-a inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                >
                  Go to site
                  <svg
